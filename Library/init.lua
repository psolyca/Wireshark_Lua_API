...
-- Generate the wtap_filetypes items for file types, for backwards compatibility.
...
-- get it from get_wtap_filetypes()
--- @class wtap_filetypes
wtap_filetypes = {}
